  ...
  render() {
    ...
    return <div class="W(80%) Mx(a)">
      ...
      <div class="Fw(b) W(100%) Py(8px) Bdbs(s) Bdbw(1px) Bdbc(#f2f2f2)">
        <Link to="/artist/all" class={'Px(20px) Cur(p) Td(n):h Py(9px) Bdbc(#ec84a2):h C(#ec84a2):h  Bdbs(s):h Bdbw(2px) ' + (tab === ALL ? 'C(#ec84a2) Bdbs(s)' : 'C(gray)')}>All</Link>
        <Link to="/artist/popular" class={'Px(20px) Cur(p) Td(n):h Py(9px) Bdbc(#ec84a2):h C(#ec84a2):h  Bdbs(s):h Bdbw(2px) ' + (tab === POPULAR ? 'C(#ec84a2) Bdbs(s)' : 'C(gray)')}>Popular tracks</Link>
        <Link to="/artist/tracks" class={'Px(20px) Cur(p) Td(n):h Py(9px) Bdbc(#ec84a2):h C(#ec84a2):h  Bdbs(s):h Bdbw(2px) ' + (tab === TRACKS ? 'C(#ec84a2) Bdbs(s)' : 'C(gray)')}>Tracks</Link>
        <Link to="/artist/albums" class={'Px(20px) Cur(p) Td(n):h Py(9px) Bdbc(#ec84a2):h C(#ec84a2):h  Bdbs(s):h Bdbw(2px) ' + (tab === ALBUMS ? 'C(#ec84a2) Bdbs(s)' : 'C(gray)')}>Albums</Link>
      </div>
      <div class="D(f)">
