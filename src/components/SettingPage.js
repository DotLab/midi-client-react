...
export default class SettingPage extends React.Component {
  ...
  render() {
    ...
    return <div class="W(80%) Mx(a)">
      <div class="D(f) Jc(c)">
        <div class="M(20px)">
          <div class="Fw(600) W(maxc) Py(10px)">Personal settings</div>
          <div class="My(4px)"><Link to="/settings/profile" class={'Cur(p) Fz(16px) C($pink):h Td(n):h ' + (tab === PROFILE ? 'C($pink) Fw(600)' : 'C(#999999) Fw(n)')}>{PROFILE}<span class="Fl(end)"></span></Link></div>
          <div class="My(4px)"><Link to="/settings/account" class={'Cur(p) Fz(16px) C($pink):h Td(n):h ' + (tab === ACCOUNT ? 'C($pink) Fw(600)' : 'C(#999999) Fw(n)')}>{ACCOUNT}<span class="Fl(end)"></span></Link></div>
          <div class="My(4px)"><Link to="/settings/security" class={'Cur(p) Fz(16px) C($pink):h Td(n):h ' + (tab === SECURITY ? 'C($pink) Fw(600)' : 'C(#999999) Fw(n)')}>{SECURITY}<span class="Fl(end)"></span></Link></div>
        </div>
